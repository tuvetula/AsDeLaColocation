...
<div class="screen container px-1 px-md-3">
    ...
    foreach ($usersArray as $key => $value) {
        ...
        <div class="card m-0 p-3 my-3 m-md-3">
            <div class="row">
                <div class="col-sm-12 col-md-8 col-lg-9">
                        <h5 class="mt-0 font-weight-bold"><?=$usersArray[$key]['user_name'].' '.$usersArray[$key]['user_firstName']?></h5>
                ...
                <div id="buttonsAdvertisement" class="col-sm-12 col-md-6 col-lg-3 pt-3 pt-md-0">
                    <div class="row">
                        ...
                        <div class="col-6 text-center custom-control custom-switch">
                            <input type="checkbox"
                                onchange="changeIsMemberState(<?=$usersArray[$key]['user_id']?>)"
                        ...
                        <div class="col-6 text-center">
                            <a
                                href="index.php?page=displayUserAdvertisement&userId=<?=$usersArray[$key]['user_id']?>"><img
                                    src="public/pictures/icons/iconeAnnonce32.png" alt="Voir les annonces de l'utilisateur"
        ...
        ?>
        <script src="public/js/confirmBeforeDeleteUser.js"></script>
