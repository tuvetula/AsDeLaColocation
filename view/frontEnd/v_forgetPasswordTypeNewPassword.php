    ...
    <div class="jumbotron px-1 px-md-3">
        ...
        <form method="post" action="index.php" onsubmit="spinnerSubmitButton()">
            ...
            <div class="form-group offset-md-2 col-md-8 offset-lg-3 col-lg-6">
                ...
                <input type="password" class="form-control form-control-lg" id="passwordReinitialization1"
                    name="passwordReinitialization1" placeholder="Saisir un nouveau mot de passe" maxlength="255"
                    required>
                <?php if (isset($fillingError['passwordReinitialization1'])){ ?>
                <p class="text-danger font-weight-bold mb-0 pb-1" type="error">
                    <?=$fillingError['passwordReinitialization1']?></p>
                <?php } ?>
            </div>
            <div class="form-group offset-md-2 col-md-8 offset-lg-3 col-lg-6">
                <label class="font-weight-bold" for="passwordReinitialization2">Confirmation du nouveau mot de
                    passe</label>
                <input type="password" class="form-control form-control-lg" id="passwordReinitialization2"
                    name="passwordReinitialization2" placeholder="Confirmer le nouveau mot de passe" maxlength="255"
                    required>
                <?php if (isset($fillingError['passwordReinitialization1'])){ ?>
            ...
            <div class="container text-center pt-3">
                <button id="submitButton" type="submit"
                    class="btn btn-primary col-6 col-sm-4 col-lg-3">Soumettre</button>
            </div>
            <?php
