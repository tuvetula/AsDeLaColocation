    ...
    <div class="jumbotron px-1 px-md-3">
        ...
        <form id="form1" method="post" action="index.php?page=saveSubscribe" onsubmit="spinnerSubmitButton()">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-lg-2">
                        ...
                        <select id="civility" name="civility" class="custom-select">
                            <option value="Madame" <?php if (isset($_POST['civility']) && $_POST['civility'] == 'Madame') {
                        echo "selected";
                    } elseif (!isset($_POST['civility'])) {
                        echo "selected";
                    }?>>
                                Madame</option>
                            <option value="Monsieur" <?php if (isset($_POST['civility']) && $_POST['civility'] == 'Monsieur') {
                        echo "selected";
                    }?>>
                                Monsieur</option>
                        </select>
                    ...
                    <div class="form-group col-lg-5">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Nom" maxlength="125" <?php if (isset($_POST['name'])) {
                        echo 'value="'.$_POST['name'].'"';
                    } ?> required>
                        <?php if (isset($fillingError['name'])) { ?>
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error"><?=$fillingError['name']?>
                        </p>
                        <?php } ?>
                    </div>
                    <!-- Prénom -->
                    <div class="form-group col-lg-5">
                        ...
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error">
                            <?=$fillingError['firstName']?></p>
                        <?php } ?>
                    </div>
                </div>
                <!-- Date de naissance -->
                <div class="row">
                    <div class="form-group col-md-4" title="Date de naissance">
                        <label for="dateOfBirth" class="font-weight-bold">Date de naissance</label>
                        <input class="form-control" type="date" id="dateOfBirth" name="dateOfBirth" value="<?php if (isset($_POST['dateOfBirth'])) {
                        echo $_POST['dateOfBirth'];
                    }?>" required>
                        <?php if (isset($fillingError['dateOfBirth'])) { ?>
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error">
                            <?=$fillingError['dateOfBirth']?></p>
                        <?php } ?>
                    </div>
                </div>
                <!-- Adresse -->
                <div class="row">
                    <div class="form-group col-md-12" title="Numéro, nom de rue">
                        ...
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error"><?=$fillingError['street']?>
                        </p>
                        <?php } ?>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-lg-3" title="Code postal">
                        ...
                        <input id="zipcode" type="text" name="zipcode" class="form-control" placeholder="Code postal"
                            maxlength="20" <?php if (isset($_POST['zipcode'])) {
                        echo 'value="'.$_POST['zipcode'].'"';
                    }?> required>
                        <?php if (isset($fillingError['zipcode'])) { ?>
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error"><?=$fillingError['zipcode']?>
                        </p>
                        <?php } ?>
                    </div>
                    <!-- Ville -->
                    <div class="form-group col-md-8 col-lg-5" title="Ville">
                        ...
                        <input id="city" type="text" name="city" class="form-control" placeholder="Ville" maxlength="60" <?php if (isset($_POST['city'])) {
                        echo 'value="'.$_POST['city'].'"';
                    }?> required>
                        <?php if (isset($fillingError['city'])) { ?>
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error"><?=$fillingError['city']?>
                        </p>
                        <?php } ?>
                    </div>
                    <!-- Pays -->
                    <div class="form-group col-md-12 col-lg-4" title="Pays">
                        ...
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error"><?=$fillingError['country']?>
                        </p>
                        <?php } ?>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error">
                            <?=$fillingError['phoneNumber']?></p>
                        <?php } ?>
                    </div>
                </div>
            </div>
            <h2 class="pt-3">Mot de passe</h2>
            <div class="container">
                <div class="row">
                    <!-- mot de passe 1 -->
                    <div class="form-group col-md-6">
                        ...
                        <input id="passwordSubscribe1" type="password" name="passwordSubscribe1" class="form-control"
                            placeholder="Saisir un mot de passe" maxlength="255" <?php if (isset($_POST['passwordSubscribe1'])) {
                        echo 'value="'.$_POST['passwordSubscribe1'].'"';
                    }?> required>
                        <?php if (isset($fillingError['passwordSubscribe1'])) { ?>
                        <p class="text-danger font-weight-bold mb-0 pb-1" type="error">
                            <?=$fillingError['passwordSubscribe1']?></p>
                        <?php } ?>
                    </div>
                    <!-- mot de passe 2 -->
                    <div class="form-group col-md-6">
                        ...
                        <input id="passwordSubscribe2" type="password" name="passwordSubscribe2" class="form-control"
                            placeholder="Confirmer le mot de passe" maxlength="255" <?php if (isset($_POST['passwordSubscribe2'])) {
            ...
            <div class="container text-center pt-3">
                <button id="submitButton" type="submit" class="btn btn-primary col-6 col-sm-4 col-lg-3">S'inscrire</button>
            </div>
        </form>
    </div>
</div>
