            ...
            <div class="container py-3 px-0 px-md-3 border-bottom border-dark">
                ...
                <div class="container">
                    ...
                    <div class=" custom-control custom-checkbox pb-3">
                        <input type="checkbox" class="custom-control-input" id="isActive" name="isActive" <?php if ((isset($advertisementData[0]['advertisement_isActive']) && $advertisementData[0]['advertisement_isActive']) || (isset($postData['advertisement_isActive']) && $postData['advertisement_isActive'])){
                            echo 'checked'; }?>>
